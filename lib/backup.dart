...
class RankingScreen extends StatelessWidget {
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView(
                children: [
                  _buildRankingItem(1, 'Jogador 1', 150, 'Nível 3'),
                  _buildRankingItem(2, 'Jogador 2', 120, 'Nível 2'),
                  _buildRankingItem(3, 'Jogador 3', 100, 'Nível 1'),
                  _buildRankingItem(4, 'Jogador 4', 90, 'Nível 2'),
                  _buildRankingItem(5, 'Jogador 5', 80, 'Nível 1'),
                ],
              ),
            ),
            Text(
              'Nota: Ranking será implementado com SQLite',
  ...
  Widget _buildRankingItem(int position, String name, int score, String level) {
    return Card(
      child: ListTile(
